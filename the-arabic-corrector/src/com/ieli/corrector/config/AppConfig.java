...
@Configuration
@EnableWebMvc
@ComponentScan(basePackages = "com.ieli.corrector")
public class AppConfig extends WebMvcConfigurerAdapter {
	...
	public void addInterceptors(InterceptorRegistry registry) {
		...
		interceptor.setParamName("arrcorrlocale");
		registry.addInterceptor(interceptor);
	}

	public void addResourceHandlers(ResourceHandlerRegistry registry) {
		registry.addResourceHandler(new String[] { "/resources/**", "/webjars/**" })
				.addResourceLocations(new String[] { "/resources/", "/webjars/" })
